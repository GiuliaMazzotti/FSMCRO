...
SNFRAC,RADSBG,ZOFFST,OSHDTN,HN_ON,FOR_HN,CRO_ON,MET1D_ON,TVT_ON
...
namelist  /nam_modconf/ NALBEDO,NCANMOD,NCONDCT,NDENSTY,NEXCHNG,NHYDROL,NSNFRAC,NRADSBG, &
          NZOFFST,NOSHDTN,LHN_ON,LFOR_HN,LCRO_ON,LMET1D_ON,LTVT_ON
...
read(1103) fsnow
read(1104) Nsnow
Sice(:,:,:) = 0. !read(1106) Sice
Sliq(:,:,:) = 0. !read(1107) Sliq
read(1116) Tsrf
