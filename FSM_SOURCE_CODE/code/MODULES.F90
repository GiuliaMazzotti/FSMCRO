...
real, parameter :: &
  ...
  undef =  1.e+20      ! Initialization value for allocatables
integer, parameter :: &
...
logical :: &
  ...
  CRO_ON,      & ! activate the use of CROCUS (snowcro)
  MET1D_ON,    & ! provide 1D meteo data to be applied to entire domain
  TVT_ON         ! use time-varying canopy transmissivity for SWR
end module MODCONF
